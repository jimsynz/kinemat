defimpl Kinemat.Orientation, for: Kinemat.Orientations.Quaternion do
  ...
  ## Examples
      ...
      iex> Quaternion.init(~a(2)r, -0.25, 0.5, -0.25)
  ...
  ## Examples
      ...
      iex> Quaternion.init(~a(0.978015)r, 0.135224, 0.137461, 0.0794041)
